...
<div class="container p-4" id="login">
    <div class="col-lg-6 col-md-12 mb-4 mb-md-0  m-auto">
        <form class="form_container" action="" method="POST" autocomplete="off">

            <img src="" width="50%" height="60%" alt="logo" />
            ...
            <div class="input container">
                ...
                <input placeholder="name@mail.com" name="email" type="email" class="input_field" id="email_field" value="">
            ...
            <div class="input container">
                ...
                <input placeholder="Password" name="password" type="password" class="input_field" id="password_field" value="">
                <span class="text-danger"></span>
            </div>
            ...
            <button title="Sign In" type="submit" class="btn btn-primary">
